...
namespace WpfHocvien.Migrations
{
    ...
    [Migration("20250220051623_addHvDb")]
    partial class addHvDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WpfHocvien.Models.Diemthi", b =>
                {
            ...
            modelBuilder.Entity("WpfHocvien.Models.Lop", b =>
                {
            ...
            modelBuilder.Entity("WpfHocvien.Models.Lylich", b =>
                {
                    b.Property<string>("Mshv")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WpfHocvien.Models.Monhoc", b =>
                {
                    b.Property<string>("Msmh")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WpfHocvien.Models.Diemthi", b =>
                {
                    b.HasOne("WpfHocvien.Models.Lylich", "MshvNavigation")
                        .WithMany("Diemthis")
                        .HasForeignKey("Mshv")
                        .IsRequired()
                        .HasConstraintName("FK_diemthi_lylich");

                    b.HasOne("WpfHocvien.Models.Monhoc", "MsmhNavigation")
                        .WithMany("Diemthis")
                        .HasForeignKey("Msmh")
                        .IsRequired()
            ...
            modelBuilder.Entity("WpfHocvien.Models.Lylich", b =>
                {
                    b.HasOne("WpfHocvien.Models.Lop", "MalopNavigation")
                        .WithMany("Lyliches")
                        .HasForeignKey("Malop")
